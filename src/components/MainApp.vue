        ...
        <div class="container">
            ...
            <div class="popular-tours">
                ...
                <div class="second-triple">
                    ...
                    <div class="your-tour">
                        <h1 class="your-title">Crafting Your <br> Perfect Travel Experience</h1>
                        <button class="your-btn">
                            <div class="btn-text">
                                <p class="your-text">Browse <br> All destinations</p> 
                                <img src="../assets/main/Link.png" alt="" class="your-link">
                            </div>
                        </button>
                    </div>
                ...
                <div class="footer-content">
                    <div class="support">
                        ...
                        <div class="footer-section">
                            <img class="icon" src="../assets/footer/location.png" alt="">
                            <p class="address">4517 Washington Ave. Manchester, Kentucky <span class="address-span">39495</span></p>
                        </div>

                        <div class="footer-section">
                            <img class="icon" src="../assets/footer/clock.png" alt="">
                            <p class="time">Hours: 8:00 - 17:00, Mon - Sat</p>
                        </div>

                        <div class="footer-section">
                            <img class="icon" src="../assets/footer/mail.png" alt="">
                            <p class="mail">support@travila.com</p>
                        </div>
                    ...
                    <div class="footer-services">
                        <ul class="services-list">
                            ...
                            <li class="footer-service">Tour Guide</li>
                            <li class="footer-service">Tour Booking</li>
                            <li class="footer-service">Hotel Booking</li>
                        </ul>

                        <ul class="footer-services-list-2">
                            <li class="footer-service">Ticket Booking</li>
                            <li class="footer-service">Rental Services</li>
                            <li class="footer-service">Travel plane</li>
                        </ul>
                    </div>

                    <div class="newsletter-section">
                        <h3 class="newsletter-title">Subscribe For Newsletter</h3>
                        <form action="">
                            <input type="email" placeholder="Enter your email" class="form-input">
                            <button class="form-btn">Subscribe</button>
                        </form>
                        <p class="postscript">No ads. No trails. No commitments</p>
                    </div>
